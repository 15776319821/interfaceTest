...
url = ip_port + readExcel.readExcel().get_xls('group_run.xlsx', 'distribution_save')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('group_run.xlsx', 'distribution_save')   #病案等级设置历史
