...
url = ip_port + readExcel.readExcel().get_xls('group_run.xlsx', 'itemLabelAllot_save')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('group_run.xlsx', 'itemLabelAllot_save')   #质控规则组分配
