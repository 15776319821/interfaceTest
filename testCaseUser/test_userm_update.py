...
url = ip_port + readExcel.readExcel().get_xls('User.xlsx', 'userm_update')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('User.xlsx', 'userm_update')   #用户列表
