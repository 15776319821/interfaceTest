...
url = ip_port + readExcel.readExcel().get_xls('group_run.xlsx', 'itemLabel_listLabel')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('group_run.xlsx', 'itemLabel_listLabel')   #病案等级设置
