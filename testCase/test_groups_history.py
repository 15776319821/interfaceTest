...
url = ip_port + readExcel.readExcel().get_xls('userCase01.xlsx', 'groups_history')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('userCase01.xlsx', 'groups_history')   #病案等级设置历史
...
class testLevel(unittest.TestCase):
    ...
    def checkResult(self):# 断言
        ...
        info = RunMain().run_main(self.method, url, data2, token)# 根据Excel中的method调用run_main来进行requests请求，并拿到响应
