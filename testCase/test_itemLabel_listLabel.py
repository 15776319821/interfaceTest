...
url = ip_port + readExcel.readExcel().get_xls('userCase01.xlsx', 'itemLabel_listLabel')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('userCase01.xlsx', 'itemLabel_listLabel')   #病案等级设置
...
class testLevel(unittest.TestCase):
    ...
    def test_itemLabel_listLabel(self):
        self.checkResult()
