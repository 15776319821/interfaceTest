...
url = ip_port + readExcel.readExcel().get_xls('userCase01.xlsx', 'userm_list')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('userCase01.xlsx', 'userm_list')   #病案等级设置
