...
url = ip_port + readExcel.readExcel().get_xls('User.xlsx', 'userm_auth_history')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('User.xlsx', 'userm_auth_history')   #用户列表
...
class testUser(unittest.TestCase):
    ...
    def test_userm_auth_history(self):
        self.checkResult()
