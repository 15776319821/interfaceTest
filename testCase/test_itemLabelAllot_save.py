...
url = ip_port + readExcel.readExcel().get_xls('userCase01.xlsx', 'itemLabelAllot_save')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('userCase01.xlsx', 'itemLabelAllot_save')   #质控规则组分配
...
class testLevel(unittest.TestCase):
    ...
    def test_itemLabelAllot_save(self):
        self.checkResult()
