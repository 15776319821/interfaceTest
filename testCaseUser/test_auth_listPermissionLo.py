...
url = ip_port + readExcel.readExcel().get_xls('User.xlsx', 'auth_listPermissionLo')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('User.xlsx', 'auth_listPermissionLo')   #用户权限组历史
...
class testUser(unittest.TestCase):
    ...
    def test_auth_listPermissionLo(self):
        self.checkResult()
