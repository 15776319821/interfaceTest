...
url = ip_port + readExcel.readExcel().get_xls('User.xlsx', 'user_profession')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('User.xlsx', 'user_profession')   #用户列表
