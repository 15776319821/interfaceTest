...
url = ip_port + readExcel.readExcel().get_xls('userCase01.xlsx', 'user_baseInfo')[0][1] + '?'
print(url)
login_xls = readExcel.readExcel().get_xls('userCase01.xlsx', 'user_baseInfo')
...
class testUserLogin(unittest.TestCase):
    ...
    def checkResult(self):# 断言
        ...
        if self.case_name == 'checkStatus0' :  #如果case_name是login，说明合法，返回的code应该为200
            self.assertEqual(ss['data']['userName'], "田磊")
