...
url = ip_port + readExcel.readExcel().get_xls('User.xlsx', 'auth_modifyAuthDetail')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('User.xlsx', 'auth_modifyAuthDetail')   #用户权限组保存
...
class testUser(unittest.TestCase):
    ...
    def test_auth_modifyAuthDetail(self):
        self.checkResult()
