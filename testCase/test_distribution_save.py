...
url = ip_port + readExcel.readExcel().get_xls('userCase01.xlsx', 'distribution_save')[0][1]
print(url)
login_xls = readExcel.readExcel().get_xls('userCase01.xlsx', 'distribution_save')   #病案等级设置历史
...
class testGroup(unittest.TestCase):
    ...
    def test_distribution_save(self):
        self.checkResult()
    ...
    def checkResult(self):# 断言
        ...
        print(self.query.encode("utf-8"))
        log.info(self.query.encode("utf-8"))
